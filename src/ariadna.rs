...
/// с императивной рамкой; при потере ответа — один фолбэк-прогон на
/// английском императиве (доказанный вживую рецепт выхода из «пустого»
/// thinking). Английский ответ самой модели — не повод для ретрая: это
/// штатный фолбэк.
